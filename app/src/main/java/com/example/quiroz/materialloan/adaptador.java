        ...
        switch (groupPosition){
            case 0:
                switch (childPosition){
                    case 0:
                        textvw.setCompoundDrawablesWithIntrinsicBounds(R.drawable.quiroz, 0, 0, 0);
                        break;
                    case 1:
                        textvw.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
                        break;
                    case 2:
                        textvw.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
                        break;
            ...
            case 1:
                switch (childPosition){
                    case 0:
                        textvw.setCompoundDrawablesWithIntrinsicBounds(R.drawable.abel, 0, 0, 0);
                        break;
                    case 1:
                        textvw.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
                        break;
